...
class User(db.Model):
    ...
    created = db.relationship('Issue', backref='user', lazy=False)
...
class Issue(db.Model):
    ...
    userId = db.Column(Integer, db.ForeignKey('question.quesId'))
    question = db.relationship('Question', backref='issue', lazy=False)
